...
#if 0
static char truly_overclock_offset[2] = {0x00, 0x80}; /* DTYPE_GEN_WRITE1 */
static char truly_overclock[6] = {0xC0, 0x00, 0x58, 0x00, 0x10, 0x10}; /* DTYPE_GEN_LWRITE */
#endif
/* MM-VH-DISPLAY-NICKI14*]*/
#ifdef CONFIG_FIH_SW_LCM_BC
...
/* MM-VH-DISPLAY-NICKI14*[ */
#if 0
	{DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(truly_overclock_offset), truly_overclock_offset},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(truly_overclock), truly_overclock},
#endif
/* MM-VH-DISPLAY-NICKI14*]*/
/* MM-VH-DISPLAY-NICKI21+[ */
